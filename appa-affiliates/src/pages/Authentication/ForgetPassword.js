...
// action
import { userForgetPassword, resetForgetPasswordFlag } from "../../store/actions";
...
const ForgetPasswordPage = props => {
  ...
  useEffect(() => {
    if (forgetSuccessMsg !== null) {
        dispatch(resetForgetPasswordFlag());
    }
              ...
              <Card className="mt-4">
                ...
                <CardBody className="p-4">
                  <div className="text-center mt-2">
                    <h5 style={{ color: '#f7941d' }}>Forgot Password?</h5>
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="text-center mt-4">
                        <Button color="dark" disabled={forgetError ? false : loading ? true : false} className="btn btn-dark w-100" type="submit">
                            {forgetError ? false : loading ? <Spinner size="sm" className='me-2'> Loading... </Spinner> : null}
                            Send Reset Link
                        </Button>
