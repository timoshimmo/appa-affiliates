...
//Appa Register
export const POST_APPA_REGISTER = "/auth/affiliates/register";

//Appa Login
export const POST_APPA_LOGIN = "/auth/affiliates/login";

//Appa Forgot Password
export const POST_APPA_FORGOT_PASSWORD = "/auth/affiliates/forgot-password";

//Appa Validate Token
export const POST_APPA_VALIDATE_TOKEN = "/auth/affiliates/verify-token";

//Appa Reset Password
export const POST_APPA_RESET_PASSWORD = "/auth/affiliates/reset-password";
